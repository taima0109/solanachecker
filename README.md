...
Revert README - fixing a bugImprove build - improving performanceOptimize UI - improving performanceRefactor configuration - fixing a bugOptimize database - handling edge casesChange UI - refactoring codeRefactor dependencies - enhancing logs