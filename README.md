...
Revert README - fixing a bugImprove build - improving performanceOptimize UI - improving performanceRefactor configuration - fixing a bugOptimize database - handling edge cases