...
Revert README - fixing a bugImprove build - improving performanceOptimize UI - improving performanceRefactor configuration - fixing a bugOptimize database - handling edge casesChange UI - refactoring codeRefactor dependencies - enhancing logsAdd UI - handling edge casesOptimize database - removing deprecated functionDocument database - removing deprecated functionRefactor README - improving securityChange styles - fixing a bugDocument configuration - fixing typoImprove API - improving securityRevert auth - updating docsUpdate database - adding new featureDocument configuration - handling edge casesImprove README - removing deprecated functionFix dependencies - adding new featureImprove tests - improving performanceAdd build - handling edge casesUpdate styles - refactoring codeRevert tests - handling edge casesFix API - refactoring code