...
Revert auth - fixing typoOptimize API - removing deprecated functionRemove API - improving securityUpdate build - updating docsImprove configuration - handling edge casesChange API - updating docsOptimize auth - handling edge cases