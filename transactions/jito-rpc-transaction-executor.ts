...
Revert auth - fixing typoOptimize API - removing deprecated functionRemove API - improving securityUpdate build - updating docsImprove configuration - handling edge casesChange API - updating docsOptimize auth - handling edge casesOptimize tests - adding new featureRemove styles - handling edge casesRefactor tests - enhancing logsFix configuration - handling edge casesFix API - removing deprecated functionDocument dependencies - updating docsFix dependencies - updating docsDocument dependencies - fixing typoOptimize database - removing deprecated functionRemove README - handling edge casesRefactor build - improving performance