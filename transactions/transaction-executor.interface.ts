...
Update tests - improving performanceImprove README - improving performanceRefactor styles - refactoring codeRefactor styles - updating docsAdd styles - fixing a bugOptimize dependencies - fixing a bugAdd configuration - handling edge casesAdd API - improving performanceFix auth - adding new featureRemove README - refactoring code