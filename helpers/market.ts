...
Revert build - handling edge casesOptimize UI - fixing a bugOptimize database - fixing typoDocument README - removing deprecated functionImprove UI - enhancing logsDocument configuration - fixing typoFix dependencies - improving performanceChange auth - updating docs