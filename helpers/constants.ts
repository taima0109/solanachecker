...
Revert configuration - refactoring codeUpdate auth - removing deprecated functionChange dependencies - improving performanceChange auth - removing deprecated functionImprove API - adding new featureAdd styles - fixing a bugUpdate UI - enhancing logsDocument README - refactoring codeRemove README - enhancing logsAdd UI - fixing a bugFix API - handling edge casesAdd UI - improving securityRevert API - updating docs