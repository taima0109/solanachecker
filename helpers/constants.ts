...
Revert configuration - refactoring codeUpdate auth - removing deprecated functionChange dependencies - improving performanceChange auth - removing deprecated functionImprove API - adding new featureAdd styles - fixing a bugUpdate UI - enhancing logsDocument README - refactoring code