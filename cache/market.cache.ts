...
Optimize styles - improving performanceImprove UI - fixing a bugRevert README - fixing typoOptimize dependencies - fixing a bugUpdate auth - removing deprecated functionUpdate README - updating docsUpdate database - fixing a bugFix README - enhancing logsAdd build - updating docsOptimize configuration - removing deprecated functionRemove configuration - improving securityRevert UI - fixing typoFix dependencies - fixing a bugRemove styles - handling edge casesRefactor build - enhancing logsImprove dependencies - removing deprecated functionImprove UI - handling edge casesAdd UI - adding new feature